...
class AIImageDetector:
    """checks if an image is potentially generated by an AI"""
    ...
    def is_common_ai_size(self, width: int, height: int, tolerance: int = None) -> Tuple[bool, str]:
        ...
        for ai_width, ai_height in self.AI_COMMON_SIZES:
            if (abs(width - ai_width) <= tolerance and abs(height - ai_height) <= tolerance):
        ...
        for ai_width, ai_height in self.AI_COMMON_SIZES:
            for multiplier in multipliers:
                ...
                if (abs(width - scaled_width) <= tolerance and abs(height - scaled_height) <= tolerance):
    ...
    def is_ai_image(self, image_path) -> Tuple[bool, str]:
        """
